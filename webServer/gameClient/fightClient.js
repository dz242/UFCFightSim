...
//	document.getElementById('f1_Move4').innerHTML= move;
	...
	f1_td_avg = parseFloat(fighter1_data["td_avg"]);
	f1_td_land_pct = parseFloat(fighter1_data["td_land_pct"]);
...
//	document.getElementById('f2_Move4').innerHTML= move;
	f2_sig_str_land_pM = fighter2_data["sig_str_land_pM"];
        ...
        f2_td_avg = parseFloat(fighter2_data["td_avg"]);
        f2_td_land_pct = parseFloat(fighter2_data["td_land_pct"]);
...
//	document.getElementById('f3_Move4').innerHTML= move;
	f3_sig_str_land_pM = fighter3_data["sig_str_land_pM"];
        ...
        f3_td_avg = parseFloat(fighter3_data["td_avg"]);
        f3_td_land_pct = parseFloat(fighter3_data["td_land_pct"]);
